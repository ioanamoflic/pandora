...
def get_RSA():
    ...
    # n_2048
    # = int("2519590847565789349402718324004839857142928212620403202777713783604366202070"
    ...
    # "6373289912154831438167899885040445364023527381951378636564391212010397122822" "120720357")
    n_576 = int("18819881292060796383869723946165043980716356337941738270076335642298885971523466548531"
                "9060606504743045317388011303396716199692321205734031879550656996221305168759307650257059")
    rsa_pe_small = RSAPhaseEstimate.make_for_shor(big_n=n_576, g=9)
