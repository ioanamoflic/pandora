...
begin
    ...
    while run_nr > 0 loop
        ...
        select * into cx from (select * from linked_circuit lc tablesample system_rows(sys_range)) as it where type = 'CXPowGate' and visited = false for update skip locked limit 1;
