...
if __name__ == "__main__":
    ...
    pandora_optimizer = PandoraOptimizer(pass_count=int(1e8),
                                         timeout=3600,
                                         logger_id=N_BITS,
                                         proc_count=25)
    ...
    for inst in adder_circuit.data:
        ...
        # Z rotations (T, S, RZ, etc.)
        elif name in ["rz", "p", "t", "tdg", "s", "sdg", "z"]:
            zrot += 1
    ...
    pandora_optimizer.cancel_single_qubit_gates(gate_types=(H, H), gate_params=(0, 0), dedicated_nproc=4)
    ...
    print("Number of CNOT gates:", cx)
    print("Number of X gates:", x)
    print("Number of H gates:", h)
    print("Number of ZROT gates:", zrot)